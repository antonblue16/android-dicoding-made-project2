...
public class FilmAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View view, ViewGroup parent)
    {
        ...
        if(view == null)
        {
            ...
            view = mInflater.inflate(R.layout.film_search_items, null);
            holder.textViewFilmName = view.findViewById(R.id.tvSearchTitle);
            holder.textViewFilmSynopsis = view.findViewById(R.id.tvSearchOverviewFilm);
            holder.textViewFilmDateTime = view.findViewById(R.id.tvSearchDateTimeFilm);
            holder.imageViewImageFilm = view.findViewById(R.id.ivSearchImageFilm);
